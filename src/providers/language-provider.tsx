...
const translationsData: Record<LanguageCode, Record<string, string>> = {
  ...
  fr: { 
    ...
    'account.apiKey.apiRestrictedError': "L'accès à l'API Binance est restreint depuis votre emplacement actuel. Vérifiez les conditions d'utilisation de Binance ou contactez leur support si vous pensez qu'il s'agit d'une erreur. Les données publiques du marché seront utilisées à la place.",
    ...
    'account.apiKey.connectButton': "Connecter à Binance",
    ...
    'account.apiKey.toast.connectionFailedTitle': "Échec de Connexion API",
    ...
    'account.apiKey.toast.connectedDescription': "Connecté avec succès à l'API Binance.",
  ...
  hi: { 
    ...
    'account.apiKey.title': "बायनेंस API कनेक्शन",
    ...
    'account.apiKey.connectedStatus': "बायनेंस API से कनेक्टेड।",
    'account.apiKey.notConnectedStatus': "बायनेंस API से कनेक्टेड नहीं।",
    'account.apiKey.apiRestrictedError': "आपके वर्तमान स्थान से बायनेंस API एक्सेस प्रतिबंधित है। बायनेंस की शर्तें जांचें या यदि आपको लगता है कि यह एक त्रुटि है तो उनके समर्थन से संपर्क करें। इसके बजाय सार्वजनिक बाजार डेटा का उपयोग किया जाएगा।",
    'account.apiKey.disconnectButton': "डिस्कनेक्ट करें",
    'account.apiKey.apiKeyLabel': "API कुंजी",
    'account.apiKey.apiKeyPlaceholder': "आपकी बायनेंस API कुंजी",
    'account.apiKey.apiSecretLabel': "API रहस्य",
    'account.apiKey.apiSecretPlaceholder': "आपका बायनेंस API रहस्य",
    'account.apiKey.connectButton': "बायनेंस से कनेक्ट करें",
    'account.apiKey.clearButton': "फ़ీल्ड साफ़ करें",
    'account.apiKey.retryConnectionButton': "बायनेंस के साथ कनेक्शन पुनः प्रयास करें",
    'account.apiKey.error.connectionFailed': "कनेक्शन विफल: अमान्य API कुंजी या रहस्य।",
    'account.apiKey.error.apiRestricted': "आपके स्थान से बायनेंस API एक्सेस प्रतिबंधित है। कृपया बायनेंस की शर्तें जांचें या समर्थन से संपर्क करें।",
    'account.apiKey.error.apiRestrictedShort': "API प्रतिबंधित (स्थान)",
    'account.apiKey.toast.connectionFailedTitle': "API कनेक्शन विफल",
    'account.apiKey.toast.connectionFailedDescription': "अमान्य API कुंजी या रहस्य।",
    'account.apiKey.toast.connectedTitle': "API कनेक्टेड",
    'account.apiKey.toast.connectedDescription': "बायनेंस API से सफलतापूर्वक कनेक्ट किया गया।",
    'account.apiKey.toast.disconnectedTitle': "API डिस्कनेक्टेड",
    'account.apiKey.toast.disconnectedDescription': "बायनेंस API से डिस्कनेक्ट किया गया।",
    'account.apiKey.toast.apiRestrictedTitle': "API कनेक्शन प्रतिबंधित",
    'account.apiKey.toast.apiRestrictedDescription': "आपके वर्तमान स्थान से बायनेंस API एक्सेस प्रतिबंधित है।",
  ...
  zh: { 
    ...
    'account.apiKey.toast.connectionFailedDescription': "API密钥或秘钥无效。",
    ...
    'account.apiKey.toast.disconnectedDescription': "已从币安API断开。",

...
const translationsData: Record<LanguageCode, Record<string, string>> = {
  ...
  fr: { 
    ...
    'history.table.loadingError': "Échec du chargement de l'historique des ordres.",
    ...
    'history.toast.noDataExportDescription': 'Il n\'y a aucune donnée à exporter.',
    ...
    'balance.summary.totalInvested': "Total Investi",
    'balance.summary.totalRecovered': "Total Récupéré",
    'balance.summary.netResult': "Résultat Net",
    'balance.chart.title': "Profit/Perte au Fil du Temps",
    'balance.chart.view.daily': "Quotidien",
    'balance.chart.view.monthly': "Mensuel",
    'balance.chart.noData': "Aucune donnée disponible pour la période sélectionnée.",
    'balance.chart.profit': "Profit",
    'balance.chart.loading': "Chargement des données du graphique...",
    'balance.loadingError': "Échec du chargement des données du solde.",
    'balance.toast.loadErrorTitle': 'Erreur',
    'balance.toast.loadErrorDescription': 'Impossible de charger les données du solde.',
  ...
  hi: { 
    ...
    'history.filters.pickDate': "एक तारीख चुनें",
    ...
    'history.table.header.quoteCurrency': 'कोट',
    ...
    'balance.page.title': "शेष अवलोकन",
    'balance.menuItem': "शेष",
    'balance.filters.dateRange': "तिथि सीमा",
    'balance.filters.startDate': "प्रारंभ तिथि",
    'balance.filters.endDate': "अंतिम तिथि",
    'balance.filters.pickDate': "एक तारीख चुनें",
    'balance.filters.resetButton': "फ़िल्टर रीसेट करें",
    'balance.summary.totalInvested': "कुल निवेशित",
    'balance.summary.totalRecovered': "कुल पुनर्प्राप्त",
    'balance.summary.netResult': "शुद्ध परिणाम",
    'balance.chart.title': "समय के साथ लाभ/हानि",
    'balance.chart.view.daily': "दैनिक",
    'balance.chart.view.monthly': "मासिक",
    'balance.chart.noData': "चयनित अवधि के लिए कोई डेटा उपलब्ध नहीं है।",
    'balance.chart.profit': "लाभ",
    'balance.chart.loading': "चार्ट डेटा लोड हो रहा है...",
    'balance.loadingError': "शेष डेटा लोड करने में विफल।",
    'balance.toast.loadErrorTitle': 'त्रुटि',
    'balance.toast.loadErrorDescription': 'शेष डेटा लोड नहीं किया जा सका।',
  ...
  zh: { 
    ...
    'history.table.header.quoteCurrency': '报价',
    ...
    'history.toast.csvExportSuccessDescription': '订单历史已导出到 CSV。',
    ...
    'balance.summary.totalInvested': "总投资",
    'balance.summary.totalRecovered': "总回收",
    'balance.summary.netResult': "净结果",
    'balance.chart.title': "盈亏随时间变化",
    'balance.chart.view.daily': "每日",
    'balance.chart.view.monthly': "每月",
    'balance.chart.noData': "所选期间无可用数据。",
    'balance.chart.profit': "利润",
    'balance.chart.loading': "正在加载图表数据...",
    'balance.loadingError': "加载余额数据失败。",
    'balance.toast.loadErrorTitle': '错误',
    'balance.toast.loadErrorDescription': '无法加载余额数据。',

...
const translationsData: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    'market.title': 'Market Opening Hours',
    'market.newYork': 'New York',
    'market.london': 'London',
    'market.tokyo': 'Tokyo',
    'market.hongKong': 'Hong Kong',
    'market.frankfurt': 'Frankfurt',
    'market.sydney': 'Sydney',
    'market.status.open': 'Open',
    'market.status.closed': 'Closed',
    'market.status.opensIn': 'Opens in',
    'market.status.closesIn': 'Closes in',
  },
  es: { 
    'app.name': 'SimulTradex',
    ...
    'market.title': 'Horarios de Apertura de Mercados',
    'market.newYork': 'Nueva York',
    'market.london': 'Londres',
    'market.tokyo': 'Tokio',
    'market.hongKong': 'Hong Kong',
    'market.frankfurt': 'Fráncfort',
    'market.sydney': 'Sídney',
    'market.status.open': 'Abierto',
    'market.status.closed': 'Cerrado',
    'market.status.opensIn': 'Abre en',
    'market.status.closesIn': 'Cierra en',
  },
  fr: { 
    'app.name': 'SimulTradex',

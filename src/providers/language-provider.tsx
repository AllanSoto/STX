...
const translationsData: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    'dashboard.orderOpportunitySimulator.marketPriceDisplayLabel': 'Market Price ({cur2}/{cur1})', // Kept for compatibility if still used by old logic parts
    ...
    'dashboard.orderOpportunitySimulator.toast.noDataToSave': 'There is no valid simulation data to save.',
  ...
  es: {
    ...
    'dashboard.orderOpportunitySimulator.toast.noDataToSave': 'No hay datos de simulación válidos para guardar.',
  ...
  hi: { 
    ...
    'dashboard.orderOpportunitySimulator.toast.noDataToSave': 'सहेजने के लिए कोई मान्य सिमुलेशन डेटा नहीं है।',
  ...
  zh: { 
    ...
    'dashboard.orderOpportunitySimulator.toast.noDataToSave': '没有有效的模拟数据可保存。',

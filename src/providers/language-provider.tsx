...
const translationsData: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    // Keys for the new OrderOpportunitySimulator
    ...
    'dashboard.orderOpportunitySimulator.usdtAmountLabel': 'Amount to Spend (USDT)',
    'dashboard.orderOpportunitySimulator.selectPairPlaceholder': 'Select USDT/Crypto pair',
    'dashboard.orderOpportunitySimulator.table.header.operation': 'Operación',
    'dashboard.orderOpportunitySimulator.table.header.amountCrypto1': 'Cantidad Cripto 1',
    'dashboard.orderOpportunitySimulator.table.header.marketPrice': 'Precio de Mercado',
    'dashboard.orderOpportunitySimulator.table.header.amountCrypto2': 'Cantidad Cripto 2',
    ...
    'dashboard.orderOpportunitySimulator.compraOperationPrefix': 'Compra',
    'dashboard.orderOpportunitySimulator.ventaOperationPrefix': 'Venta',
    ...
    // Zod messages for new simulator
    'zod.orderOpportunity.selectPair': 'Please select a trading pair.',
    'zod.orderOpportunity.positiveUsdtAmount': 'USDT amount must be a positive number.',
  },
  es: {
    'app.name': 'SimulTradex',
    ...
    'dashboard.orderOpportunitySimulator.usdtAmountLabel': 'Monto a Gastar (USDT)',
    'dashboard.orderOpportunitySimulator.selectPairPlaceholder': 'Selecciona par USDT/Cripto',
    'dashboard.orderOpportunitySimulator.table.header.operation': 'Operación',
    'dashboard.orderOpportunitySimulator.table.header.amountCrypto1': 'Cantidad Cripto 1',
    'dashboard.orderOpportunitySimulator.table.header.marketPrice': 'Precio de Mercado',
    'dashboard.orderOpportunitySimulator.table.header.amountCrypto2': 'Cantidad Cripto 2',
    ...
    'dashboard.orderOpportunitySimulator.enterValuesPrompt': 'Por favor, selecciona un par e ingresa el monto en USDT para ver la simulación.',
    ...
    'zod.orderOpportunity.positiveUsdtAmount': 'El monto en USDT debe ser un número positivo.',
  },
  fr: {
    'app.name': 'SimulTradex',
    ...
    'dashboard.orderOpportunitySimulator.usdtAmountLabel': 'Montant à Dépenser (USDT)',
    'dashboard.orderOpportunitySimulator.selectPairPlaceholder': 'Sélectionnez une paire USDT/Crypto',
    'dashboard.orderOpportunitySimulator.table.header.operation': 'Opération',
    'dashboard.orderOpportunitySimulator.table.header.amountCrypto1': 'Quantité Crypto 1',
    'dashboard.orderOpportunitySimulator.table.header.marketPrice': 'Prix du Marché',
    'dashboard.orderOpportunitySimulator.table.header.amountCrypto2': 'Quantité Crypto 2',
    ...
    'dashboard.orderOpportunitySimulator.compraOperationPrefix': 'Achat',
    'dashboard.orderOpportunitySimulator.ventaOperationPrefix': 'Vente',
    ...
    'dashboard.orderOpportunitySimulator.enterValuesPrompt': 'Veuillez sélectionner une paire et entrer le montant en USDT pour voir la simulation.',
    ...
    'dashboard.websocket.errorDescription': 'La connexion au flux de prix en direct a échoué. Passage aux mises à jour périodiques.',
    ...
    'zod.orderOpportunity.positiveUsdtAmount': 'Le montant USDT doit être un nombre positif.',
  },
  hi: {
    ...
    'dashboard.orderOpportunitySimulator.usdtAmountLabel': 'खर्च करने के लिए राशि (USDT)',
    'dashboard.orderOpportunitySimulator.selectPairPlaceholder': 'USDT/क्रिप्टो जोड़ी चुनें',
    'dashboard.orderOpportunitySimulator.table.header.operation': 'ऑपरेशन',
    'dashboard.orderOpportunitySimulator.table.header.amountCrypto1': 'मात्रा क्रिप्टो 1',
    'dashboard.orderOpportunitySimulator.table.header.marketPrice': 'बाजार मूल्य',
    'dashboard.orderOpportunitySimulator.table.header.amountCrypto2': 'मात्रा क्रिप्टो 2',
    ...
    'dashboard.orderOpportunitySimulator.compraOperationPrefix': 'खरीद',
    'dashboard.orderOpportunitySimulator.ventaOperationPrefix': 'बिक्री',
    ...
    'dashboard.orderOpportunitySimulator.enterValuesPrompt': 'कृपया सिमुलेशन देखने के लिए एक जोड़ी चुनें और USDT राशि दर्ज करें।',
    ...
    'zod.orderOpportunity.positiveUsdtAmount': 'USDT राशि एक सकारात्मक संख्या होनी चाहिए।',
  },
  zh: {
    'app.name': 'SimulTradex',
    ...
    'dashboard.orderOpportunitySimulator.usdtAmountLabel': '花费金额 (USDT)',
    'dashboard.orderOpportunitySimulator.selectPairPlaceholder': '选择 USDT/加密货币 交易对',
    'dashboard.orderOpportunitySimulator.table.header.operation': '操作',
    'dashboard.orderOpportunitySimulator.table.header.amountCrypto1': '加密货币数量 1',
    'dashboard.orderOpportunitySimulator.table.header.marketPrice': '市场价格',
    'dashboard.orderOpportunitySimulator.table.header.amountCrypto2': '加密货币数量 2',
    ...
    'dashboard.orderOpportunitySimulator.compraOperationPrefix': '买入',
    'dashboard.orderOpportunitySimulator.ventaOperationPrefix': '卖出',
    'dashboard.orderOpportunitySimulator.priceUnavailable': '价格不可用',
    'dashboard.orderOpportunitySimulator.calculating': '计算中...',
    'dashboard.orderOpportunitySimulator.enterValuesPrompt': '请选择一个交易对并输入USDT金额以查看模拟。',
    ...
    'dashboard.websocket.errorDescription': '连接实时价格源失败。将回退到周期性更新。',
    ...
    'zod.orderOpportunity.positiveUsdtAmount': 'USDT金额必须是正数。',
  }
};

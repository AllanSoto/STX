...
const translationsData: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    'dashboard.orderOpportunitySimulator.exchangedCryptoLabel': 'Exchanged {baseCurrency}',
  ...
  es: {
    ...
    'dashboard.orderOpportunitySimulator.exchangedCryptoLabel': 'Cripto Intercambiado {baseCurrency}',
  ...
  fr: { 
    ...
    'dashboard.orderOpportunitySimulator.exchangedCryptoLabel': 'Crypto Échangé {baseCurrency}',
  ...
  hi: { 
    ...
    'dashboard.orderOpportunitySimulator.exchangedCryptoLabel': 'एक्सचेंज किया गया {baseCurrency}',
  ...
  zh: { 
    ...
    'dashboard.orderOpportunitySimulator.exchangedCryptoLabel': '兑换的{baseCurrency}',

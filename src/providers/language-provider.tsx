...
const translationsData: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    'dashboard.orderOpportunitySimulator.investmentAmountLabel': 'Investment Amount ({currency})',
    'dashboard.orderOpportunitySimulator.purchasePriceLabel': 'Purchase Price of {baseCurrency} (in {quoteCurrency})',
    'dashboard.orderOpportunitySimulator.cryptoValueLabel': 'Crypto Value ({baseCurrency})',
  ...
  es: {
    ...
    'dashboard.orderOpportunitySimulator.investmentAmountLabel': 'Monto de Inversión ({currency})',
    'dashboard.orderOpportunitySimulator.purchasePriceLabel': 'Precio de Compra de {baseCurrency} ({quoteCurrency})',
    'dashboard.orderOpportunitySimulator.cryptoValueLabel': 'Valor Crypto ({baseCurrency})',
  ...
  fr: { 
    ...
    'dashboard.orderOpportunitySimulator.investmentAmountLabel': 'Montant de l\'Investissement ({currency})',
    'dashboard.orderOpportunitySimulator.purchasePriceLabel': 'Prix d\'Achat de {baseCurrency} ({quoteCurrency})',
    'dashboard.orderOpportunitySimulator.cryptoValueLabel': 'Valeur Crypto ({baseCurrency})',
  ...
  hi: { 
    ...
    'dashboard.orderOpportunitySimulator.investmentAmountLabel': 'निवेश राशि ({currency})',
    'dashboard.orderOpportunitySimulator.purchasePriceLabel': '{baseCurrency} का खरीद मूल्य ({quoteCurrency} में)',
    'dashboard.orderOpportunitySimulator.cryptoValueLabel': 'क्रिप्टो मान ({baseCurrency})',
    ...
    'firebase.config.errorMessageSignup': 'खाता निर्माण अनुपलब्ध है क्योंकि एप्लिकेशन फायरबेस से कनेक्ट करने के लिए ठीक से कॉन्फ़िगर नहीं है। कृपया सुनिश्चित करें कि सभी NEXT_PUBLIC_FIREBASE_... متغیرات آپ کی .env.local फ़ाइल میں درست طریقے سے سیٹ ہیں۔ سیٹ اپ ہدایات کے لیے README.md دیکھیں۔',
  ...
  zh: { 
    ...
    'dashboard.orderOpportunitySimulator.investmentAmountLabel': '投资金额 ({currency})',
    'dashboard.orderOpportunitySimulator.purchasePriceLabel': '{baseCurrency}的购买价格 (以{quoteCurrency}计价)',
    'dashboard.orderOpportunitySimulator.cryptoValueLabel': '加密货币价值 ({baseCurrency})',

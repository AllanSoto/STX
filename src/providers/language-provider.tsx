...
const translationsData: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    'account.apiKey.description': "Connect your Binance account to fetch real-time data and balances. Your keys are stored locally (mock).",
    ...
    'account.apiKey.retryConnectionButton': "Retry Connection",
  ...
  es: {
    ...
    'account.apiKey.description': "Conecta tu cuenta de Binance para obtener datos y balances en tiempo real. Tus claves se almacenan localmente (simulado).",
    ...
    'account.apiKey.retryConnectionButton': "Reintentar Conexión",
  ...
  fr: { 
    ...
    'account.apiKey.description': "Connectez votre compte Binance pour récupérer les données et soldes en temps réel. Vos clés sont stockées localement (simulation).",
    ...
    'account.apiKey.retryConnectionButton': "Réessayer la Connexion",
  ...
  hi: { 
    ...
    'account.apiKey.description': "वास्तविक समय डेटा और बैलेंस प्राप्त करने के लिए अपने बायनेंस खाते को कनेक्ट करें। आपकी कुंजियाँ स्थानीय रूप से संग्रहीत हैं (मॉक)।",
    ...
    'account.apiKey.retryConnectionButton': "कनेक्शन पुनः प्रयास करें",
  ...
  zh: { 
    ...
    'account.apiKey.description': "连接您的币安账户以获取实时数据和余额。您的密钥存储在本地（模拟）。",
    ...
    'account.apiKey.retryConnectionButton': "重试连接",
